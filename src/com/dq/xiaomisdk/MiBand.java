...
import com.dq.xiaomisdk.model.LedColor;
import com.dq.xiaomisdk.model.Profile;
import com.dq.xiaomisdk.model.Protocol;
...
//        scanner.stopScan(callback);
     ...
     * 开启实时步数通知
     */
    public void enableRealtimeStepsNotify() {//UUID_CHAR_CONTROL_POINT
        this.io.writeCharacteristic(Profile.UUID_CHAR_REALTIME_STEPS, Protocol.ENABLE_REALTIME_STEPS_NOTIFY, null);
    }
    ...
    public void disableRealtimeStepsNotify() {
        this.io.writeCharacteristic(Profile.UUID_CHAR_REALTIME_STEPS, Protocol.DISABLE_REALTIME_STEPS_NOTIFY, null);
    }
